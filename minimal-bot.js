...
console.log('🤖 Starting Minimal Arch 2 Bot...');
...
client.login(process.env.DISCORD_TOKEN).catch((error) => {
    ...
    console.log('4. Check if intents are enabled in Discord Developer Portal');
    console.log('\n📋 Required Intents:');
    console.log('- Server Members (if you want member events)');
    console.log('- Message Content (for reading messages)');
    console.log('- Server Messages (for sending messages)');
});
