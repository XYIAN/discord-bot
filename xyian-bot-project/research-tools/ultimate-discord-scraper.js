...
async function scrapeUltimateDiscordChannels() {
    console.log('🚀 Starting ultimate Discord channels scraper...');
    ...
    console.log('📊 Ultimate Discord Channels Scraping Summary:');
...
if (require.main === module) {
    scrapeUltimateDiscordChannels()
        .then(data => {
            console.log('✅ Ultimate Discord channels scraping completed successfully');
            process.exit(0);
        })
        .catch(error => {
            console.error('❌ Ultimate Discord channels scraping failed:', error);
            process.exit(1);
        });
}
