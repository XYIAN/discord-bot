...
class TrainingSystem {
    constructor() {
        this.trainingLogPath = path.join(__dirname, 'data', 'user-training', 'training-log.json');
        this.unifiedDataPath = path.join(__dirname, 'data', 'real-structured-data', 'unified_game_data.json');
        this.pendingReviewPath = path.join(__dirname, 'data', 'user-training', 'pending-review.json');
